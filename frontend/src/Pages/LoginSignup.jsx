    ...
    <div className='loginsignup'>
      <div className="container">
        ...
        <div className="fields">
          ...
          <input name='email' value={formData.email} onChange={changeHandler} type="email" placeholder='youremail@...' />
        ...
        <div className="agree">
          ...
          <p>By continuing, you agree the terms of use and privacy policy.</p>
        </div>
      </div>
    </div>
  )
